...
def set_inputs(CO2_loading, H2O_loading, lean_flowrate, Tl):
    ...
    m.fs.absorber.liquid_inlet.temperature.fix(Tl)  # 313.15)
...
def model_results():
    ...
    for x in m.fs.absorber.vapor_phase.length_domain:
        print(value(m.fs.absorber.vapor_phase.properties[0, x].pressure *
